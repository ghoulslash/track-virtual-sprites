...
bool8 __attribute__((long_call)) sub_8058244(void);
bool8 __attribute__((long_call)) sub_8056D44(u8*);
void __attribute__((long_call)) render_prev_quest_text_if_appropriate(void);
void __attribute__((long_call)) start_map_chg_seq_and_pal_fill_depending_on_room_and_tile(u8);
void __attribute__((long_call)) task0A_asap_script_env_2_enable_and_set_ctx_running(u8 taskId);
void __attribute__((long_call)) sub_80569BC(void);
bool8 __attribute__((long_call)) sub_807E3BC(void);
bool8 __attribute__((long_call)) map_loading_iteration_2_link(u8*);
void __attribute__((long_call)) SetFieldVBlankCallback_0(void);
