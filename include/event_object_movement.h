...
void __attribute__((long_call)) UnfreezeEventObject(struct EventObject *);
...
const struct EventObjectGraphicsInfo* __attribute__((long_call)) GetEventObjectGraphicsInfo(u16 graphicsId);
...
void __attribute__((long_call)) UpdateEventObjectSpriteSubpriorityAndVisibility(struct Sprite *);
void __attribute__((long_call)) sub_8063BC4(s16 *x, s16 *y, s16 dx, s16 dy);
void __attribute__((long_call)) LoadSpecialObjectReflectionPalette(u16, u8);
void __attribute__((long_call)) InitObjectPriorityByZCoord(struct Sprite* sprite, u8 z);
