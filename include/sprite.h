...
u8 __attribute__((long_call)) CreateVirtualSprite(u16 gfxId, u8 a1, s16 x, s16 y, u8 z, u8 direction);
void __attribute__((long_call)) lnpc_look(u8 vId, u8 direction);
void __attribute__((long_call)) SetSpritePosToMapCoords(s16 mapX, s16 mapY, s16 *destX, s16 *destY);
